"""spectral.py — Truncated SVD on the NPMI association matrix → token embeddings.

Ownership: core/engine/training/spectral.py
    ...
    permitted to import scipy for numerical linear algebra.
...
V1 reference: _BDHyperNeuronEMITTER/src/engine/training/spectral.py

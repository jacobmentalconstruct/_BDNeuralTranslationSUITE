"""cooccurrence.py — Sliding-window token pair co-occurrence statistics.

Ownership: core/engine/training/cooccurrence.py
...
V1 reference: _BDHyperNeuronEMITTER/src/engine/training/cooccurrence.py
